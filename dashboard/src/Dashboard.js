    ...
    <div className="dashboard-container">
      ...
      <div className="sidebar">
        <nav className="menu">
          ...
          <Link to="/home/competitors" className="menu-item">
            <i className="fas fa-map-marker-alt"></i> Competitors
          </Link>
          ...
          <Link to="/home/productrecommendations" className="menu-item">
            <i className="fas fa-question-circle"></i> Product Recommendations
          </Link>
